...
class CSuperString
{
	...
	public:
		...
		// Parameterized/Copy constructors // CSuperString ssBuffer( "I LOVE WARFRAME" ); // CSuperString ssBuffer( 3.14159f );
		...
		// Concatenate operator // Extra credit for numeric parameters
		...
		// FindFirstIndexOf // FindLastIndexOf finds the position of the first character of the last instance of the thing being searched for.
		...
		// Trimming // Left gets the first characters in the string. Right gets the last characters in the string.	
